...
class SSWSFNCT_Plugin_Links
{
    ...
    {
        // array_unshift( $links, '<a href="https://www.seatoskywebsolutions.ca/" target="_blank" style="color:#c6ff00;font-weight:bold;">' . __( 'Sea to Sky Web Solutions Website', 'ssws-functions' ) . '</a>' );
